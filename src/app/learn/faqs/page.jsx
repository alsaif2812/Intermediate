...
import {
 ...
 function AccordionAlwaysOpen() {
  ...
  return (
    ...
    <div id="mainfaq" className="max-h-[1000vw]  md:w-full md:mx-auto md:mb-20 flex flex-col lg:flex-row lg:gap-10 md:p-10">
      
      <div className="md:w-1/2 md:p-0 p-5 " id="firstfaq">
