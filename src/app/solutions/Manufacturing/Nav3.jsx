...
const page = () => {
  return (
    <>
     <div id="hero1" className="md:px-[12vw] px-[1vw] mt-[21vw] md:mt-[4vw]">
          <div id="main" className="mb-[8vw] md:mt-[-1vw] md:rounded-[2vw] rounded-2xl bg-blue-100 bg-opacity-30 md:p-[2vw] p-[4vw] md:w-[80%] w-[80vw] mx-auto text-[#292d34] lg:h-[25vw] sm:h-[35vw] shadow-lg hover:shadow-none transition duration-500">
            <div id="nav2" className=" p-[0.9vw] ">
              <ul className="flex gap-7 items-baseline font-semibold mb-[2vw] text-[2.5vw] md:text-[0.9vw]">
                <li><Link href="/solutions/Manufacturing/Nav1" className="hover:border-b-[3px] hover:border-blue-600 transition duration-300">Accounts Dashboard</Link></li>
                <li><Link href="/solutions/Manufacturing/Nav2" className="hover:border-b-[3px] hover:border-blue-600 transition duration-300">Trial balance</Link></li>
                <li><Link href="/solutions/Manufacturing/Nav3" className=" border-b-[3px] border-blue-600">Profit & Loss</Link></li>
              </ul>
            </div>
            ...
            <div id="content2" className=" md:flex md:h-[16vw] ">
              <div id="left" className="md:w-[100vh]">
                <h1 className="font-bold md:text-3xl text-[6vw] mb-6 hidden md:block">This is third dummy text<br />
                  dummy text</h1>
          ...
          <div id="main" className="mb-[8vw] md:mt-[-1vw] md:rounded-[2vw] rounded-2xl bg-blue-100 bg-opacity-30 md:p-[2vw] p-[4vw] md:w-[80%] w-[80vw] mx-auto text-[#292d34] lg:h-[25vw] sm:h-[35vw] shadow-lg hover:shadow-none transition duration-500">
            <div id="nav2" className=" p-[0.9vw] ">
              <ul className="flex gap-7 items-baseline font-semibold mb-[2vw] text-[2.5vw] md:text-[0.9vw]">
                <li><Link href="/solutions/Manufacturing/Nav1" className=" hover:border-b-[3px] hover:border-blue-600 transition duration-300">Accounts Dashboard</Link></li>
                <li><Link href="/solutions/Manufacturing/Nav2" className="hover:border-b-[3px] hover:border-blue-600 transition duration-300">Trial balance</Link></li>
                <li><Link href="/solutions/Manufacturing/Nav3" className="">Profit & Loss</Link></li>
              </ul>
            </div>
            <Image width={900} height={1000} src="https://erpnext.com/files/accounts-dashboard-1335c7cb.png" alt="Image" className="md:hidden block mt-[5vw]" />
            <div id="content2" className=" md:flex md:h-[16vw] ">
     ...
     <div id="hero3" className="md:px-[12vw] px-[1vw] ">
          <div id="main" className="mb-[8vw] md:mt-[-1vw] md:rounded-[2vw] rounded-2xl bg-blue-100 bg-opacity-30 md:p-[2vw] p-[4vw] md:w-[80%] w-[80vw] mx-auto text-[#292d34] lg:h-[25vw] sm:h-[35vw] shadow-lg hover:shadow-none transition duration-500">
            <div id="nav2" className=" p-[0.9vw] ">
              <ul className="flex gap-7 items-baseline font-semibold mb-[2vw] text-[2.5vw] md:text-[0.9vw]">
                <li><Link href="/solutions/Manufacturing/Nav1" className=" border-b-[3px] border-blue-600">Accounts Dashboard</Link></li>
                <li><Link href="/solutions/Manufacturing/Nav2" className="hover:border-b-[3px] hover:border-blue-600 transition duration-300">Trial balance</Link></li>
                <li><Link href="/solutions/Manufacturing/Nav3" className="hover:border-b-[3px] hover:border-blue-600 transition duration-300">Profit & Loss</Link></li>
              </ul>
            </div>
            <Image width={900} height={1000} src="https://erpnext.com/files/accounts-dashboard-1335c7cb.png" alt="Image" className="md:hidden block mt-[5vw]" />
            <div id="content2" className=" md:flex md:h-[16vw] ">
