  ...
  return (
    <>
      ...
      <div id="ourmission" className="md:flex md:w-full md:py-[5vw] md:pl-[10vw] ">
        <div id="leftmission" className=" md:p-[0vw] p-[8vw] md:max-w-[40%]">
          <p className="text-blue-700 font-semibold md:text-xs text-lg uppercase tracking-widest">Mission</p>
          <h1 className="md:text-4xl text-3xl font-extrabold md:mt-2 mt-[4vw] text-[#292D34] tracking-wider"> Feeling overwhelmed by accounting headaches ? </h1>
          ...
          <p className="md:mt-4 mt-[12vw] opacity-60">
            You're not alone. At Wahni IT Solutions , we understand the challenges businesses face in navigating the ever-changing financial landscape. That's why we offer a comprehensive suite of services to streamline your operations, optimize your finances, and ensure your compliance.
          </p>
        </div>
        <div id="rightmission" className="md:w-[50%] md:flex items-center justify-center ">
          <h1 className='text-5xl font-bold bg-white rounded-2xl p-10 shadow-2xl hover:scale-105 transition duration-500'> Improve <br /> <span className='text-purple-600 font-extrabold'>financial</span>  <br />  accuracy <br />  and <span className='text-purple-600 font-extrabold'>transparency</span>
          </h1>
        </div>
