    ...
    return (
        <>
            <Layout showBackgroundImage={true}>
                ...
                <div
                    id="top"
                    className="md:flex md:w-full md:h-[30vw] h-[130vw] bg-gradient-to-b from-purple-500 via-purple-600 to-blue-500"
                >
                    <div
                        id="leftabt"
                        className="md:w-[50%] md:pl-[10vw] pl-[3vw] md:pt-[4vw] pt-[10vw] md:mt-0 mt-[4vw] text-[#212121]"
                    >
                        ...
                        <p className="md:text-xl opacity-80 tracking-wide md:mt-[1vw] mt-[4vw] text-white">
                            A great workplace combines exceptional <br /> people
                ...
                <div
                    id="ourmission"
                    className="md:flex md:w-full md:pt-[5vw] md:pl-[10vw]"
                >
                    <div
                        id="leftmission"
                        className="md:w-[30%] md:p-[0vw] p-[8vw]"
                    >
                        ...
                        <p className="md:mt-4 mt-[12vw] opacity-60">
                            ...
                            elit. Excepturi saepe sed ipsam tenetur cum eaque
                            molestias sequi in tempora quod sunt, nulla dolor
                            rem odio incidunt eos illo corrupti natus culpa
                            voluptates autem iste voluptatum enim? Provident
                            soluta dolor obcaecati aliquid vero ipsam? Commodi.
                        </p>
                    ...
                    <div
                        id="rightmission"
                        className="md:w-[50%] md:p-[10vw] md:mb-[10vw] md:flex items-center justify-center p-[5vw]"
                    >
                        <Image
                            src={mission}
                            alt="img"
                            width={1000}
                            height={100}
                            className="md:object-cover shadow-2xl rounded-3xl transition hover:scale-105 duration-500"
                        />
                    </div>
                </div>
                ...
                <div
                    id="main"
                    className="md:w-full md:flex md:gap-10 md:h-[130vh] md:p-[12vw] p-[10vw]"
                >
                    ...
                    <div id="firstdiv" className="md:flex flex-col">
                        <div
                            id="first"
                            className="md:w-[18vw] p-[5vw] md:max-h-full h-[105vw] rounded-2xl md:p-[2vw] border-l-4 border-purple-400 shadow-md hover:shadow-2xl transition duration-300 md:mt-0 mt-[2vw]"
                        >
                            <p className="md:text-4xl text-3xl font-bold text-purple-400">
                                01
                            </p>
                            ...
                            <h3 className="md:mt-[0.9vw] mt-[2vw] md:text-[1vw] text-[5.5vw] font-[600]">
                                Details matter. Add value <br /> in every
                                interaction
                            </h3>
                        </div>
                        <div
                            id="Second"
                            className="mt-[8vw] md:w-[18vw] p-[5vw] md:max-h-full h-[105vw] rounded-2xl md:mt-[2vw] md:p-[2vw] border-l-4 border-purple-400 shadow-md hover:shadow-2xl transition duration-300"
                        >
                            <p className="md:text-4xl text-3xl font-bold text-purple-400">
                                02
                            </p>
                    ...
                    <div id="seconddiv" className="md:flex flex-col">
                        <div
                            id="first"
                            className="md:w-[18vw] p-[5vw] md:max-h-full h-[105vw] rounded-2xl md:mt-[0vw] mt-[8vw] md:p-[2vw] border-l-4 border-purple-400 shadow-md hover:shadow-2xl transition duration-300"
                        >
                            <p className="md:text-4xl text-3xl font-bold text-purple-400">
                                01
                            </p>
                        ...
                        <div
                            id="Second"
                            className=" md:w-[18vw] p-[5vw] md:max-h-full h-[105vw] mt-[8vw] rounded-2xl md:mt-[2vw] md:p-[2vw] border-l-4 border-purple-400 shadow-md hover:shadow-2xl transition duration-300"
                        >
                            <p className="md:text-4xl text-3xl font-bold text-purple-400">
                                02
                            </p>
                    ...
                    <div id="thirddiv" className="md:flex flex-col">
                        ...
                        <div
                            id="first"
                            className="md:w-[18vw] p-[5vw] md:max-h-full h-[105vw] rounded-2xl mt-[8vw] md:mt-0 md:p-[2vw] border-l-4 border-purple-400 shadow-md hover:shadow-2xl transition duration-300"
                        >
                            <p className="md:text-4xl text-3xl font-bold text-purple-400">
                                01
                            </p>
                ...
                <div
                    id="milestones"
                    className="md:max-w-full md:max-h-[50vw] h-[200vw] md:mt-[5vw] md:pt-[5vw] md:pl-[10vw] md:pr-[3vw] bg-gray-100"
                >
                ...
                <div
                    id="photogrid"
                    className="md:w-full md:h-[100vh] w-full h-[100vh] pt-[10vw] md:px-[0vw] px-[5vw] bg-gray-200"
                >
                ...
                <div
                    id="advantages"
                    className="md:flex md:gap-10 items-center justify-center md:w-full w-[100%] md:h-[5vw] md:mb-[9vw] text-gray-700 max-h-full md:p-[0vw] p-[5vw] bg-gray-100"
                >
                    <div
                        id="advantage1"
                        className="md:text-xl md:flex items-center"
                    >
                    ...
                    <div
                        id="advantage2"
                        className="md:my-0 my-[5vw] md:text-xl md:flex items-center"
                    >
                        <i className="ri-shield-check-line md:text-5xl md:mr-[0.1vw] md:text-center text-gray-600"></i>{' '}
                        Serious about{' '}
