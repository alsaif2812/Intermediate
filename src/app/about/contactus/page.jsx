...
export const metadata = {
  ...
  description: "Have questions or ready to transform your business with open-source ERP solutions? Reach out to Wahni ERP for expert guidance and unparalleled support. ",
