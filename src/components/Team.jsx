...
const Card = () => {
          ...
          return (
                    <>
                              ...
                              <p className='mt-10 text-center text-base text-gray-800 font-bold font-sans px-4 md:px-10'>This is our team, a lot of smiling happy people who work hard to empower your teams.</p>
