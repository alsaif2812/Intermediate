...
const HeroForFaq = () => {
          return (
                    <>
                              <div id="mainfaq" className="w-full md:max-h-screen    md:flex flex md:flex-row flex-col items-center justify-center ">
                                        <div id="top" className=' w-full h-full  flex items-center   justify-center md:hidden px-10 pt-10 '>
                                        ...
                                        <div id="left" className=' md:w-1/2 w-full md:h-full md:flex flex-col  md:justify-start md:items-center '>
                                                  <div className='md:max-w-96 w-full md:px-36 px-10  py-10 wrap'>
                                                            <div id="title" className='md:text-5xl text-4xl font-extrabold md:leading-[3.5rem] text-[#212121]'>FAQs Unveiled: Your Quick <br /> Answers Guide</div>
                                                            ...
                                                            <div id="button" className='bg-purple-400 md:py-4 py-3 md:px-6 px-12 md:w-44 w-56 rounded-lg text-md font-bold text-white'> Explore Further!!</div>
                                                  </div>
                                        </div>
