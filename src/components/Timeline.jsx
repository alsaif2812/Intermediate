...
//                                                             <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 448 512"><path fill="#ffffff" d="M96 0C43 0 0 43 0 96V416c0 53 43 96 96 96H384h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V384c17.7 0 32-14.3 32-32V32c0-17.7-14.3-32-32-32H384 96zm0 384H352v64H96c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16zm16 48H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z" /></svg>
...
//                                                             <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><path fill="#ffffff" d="M320 488c0 9.5-5.6 18.1-14.2 21.9s-18.8 2.3-25.8-4.1l-80-72c-5.1-4.6-7.9-11-7.9-17.8s2.9-13.3 7.9-17.8l80-72c7-6.3 17.2-7.9 25.8-4.1s14.2 12.4 14.2 21.9v40h16c35.3 0 64-28.7 64-64V153.3C371.7 141 352 112.8 352 80c0-44.2 35.8-80 80-80s80 35.8 80 80c0 32.8-19.7 61-48 73.3V320c0 70.7-57.3 128-128 128H320v40zM456 80a24 24 0 1 0 -48 0 24 24 0 1 0 48 0zM192 24c0-9.5 5.6-18.1 14.2-21.9s18.8-2.3 25.8 4.1l80 72c5.1 4.6 7.9 11 7.9 17.8s-2.9 13.3-7.9 17.8l-80 72c-7 6.3-17.2 7.9-25.8 4.1s-14.2-12.4-14.2-21.9V128H176c-35.3 0-64 28.7-64 64V358.7c28.3 12.3 48 40.5 48 73.3c0 44.2-35.8 80-80 80s-80-35.8-80-80c0-32.8 19.7-61 48-73.3V192c0-70.7 57.3-128 128-128h16V24zM56 432a24 24 0 1 0 48 0 24 24 0 1 0 -48 0z" /></svg>                                          </TimelineIcon>
//                                                   <Typography variant="h5" color="blue-gray">
...
//                                         <TimelineHeader>
//                                                   <TimelineIcon className="p-2 rounded-full">
//                                                             <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 640 512"><path fill="#ffffff" d="M192 96a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm-8 384V352h16V480c0 17.7 14.3 32 32 32s32-14.3 32-32V192h56 64 16c17.7 0 32-14.3 32-32s-14.3-32-32-32H384V64H576V256H384V224H320v48c0 26.5 21.5 48 48 48H592c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48H368c-26.5 0-48 21.5-48 48v80H243.1 177.1c-33.7 0-64.9 17.7-82.3 46.6l-58.3 97c-9.1 15.1-4.2 34.8 10.9 43.9s34.8 4.2 43.9-10.9L120 256.9V480c0 17.7 14.3 32 32 32s32-14.3 32-32z" /></svg>                                                           </TimelineIcon>
//                                                   <Typography variant="h5" color="blue-gray">
//                                                             Training & Deployment
//                                                   </Typography>
//                                         </TimelineHeader>
...
//                                         <TimelineHeader>
//                                                   <TimelineIcon className="p-2 rounded-full">
//                                                             <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><path fill="#ffffff" d="M256 48C141.1 48 48 141.1 48 256v40c0 13.3-10.7 24-24 24s-24-10.7-24-24V256C0 114.6 114.6 0 256 0S512 114.6 512 256V400.1c0 48.6-39.4 88-88.1 88L313.6 488c-8.3 14.3-23.8 24-41.6 24H240c-26.5 0-48-21.5-48-48s21.5-48 48-48h32c17.8 0 33.3 9.7 41.6 24l110.4 .1c22.1 0 40-17.9 40-40V256c0-114.9-93.1-208-208-208zM144 208h16c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H144c-35.3 0-64-28.7-64-64V272c0-35.3 28.7-64 64-64zm224 0c35.3 0 64 28.7 64 64v48c0 35.3-28.7 64-64 64H352c-17.7 0-32-14.3-32-32V240c0-17.7 14.3-32 32-32h16z" /></svg>                                                           </TimelineIcon>
//                                                   <Typography variant="h5" color="blue-gray">
//                                                             Ongoing Support
//                                                   </Typography>
//                                         </TimelineHeader>
...
function TimelineWithIcon({ timelineData }) {
          const timelineItems = timelineData.Timeline.map((item, index) => (
                    <TimelineItem key={index}>
                              <TimelineConnector />
                              <TimelineHeader>
                                        {item.TimelineHeader.TimelineIcon && (
                                                  <TimelineIcon className="p-2 rounded-full">
                                                            <svg
                                                                      ...
                                                                      viewBox="0 0 512 512"
                                                            >
                                                                      <path fill="#ffffff" d={item.TimelineHeader.TimelineIcon} />
                                                            </svg>
                                                  </TimelineIcon>
                                        )}
                                        <Typography variant="h5" color="blue-gray">
                                                  {item.TimelineHeader.Typography}
                                        </Typography>
                              </TimelineHeader>
                              <TimelineBody>
                                        {Array.isArray(item.TimelineBody.Typography) ? (
                                                  <Typography color="gray" className="font-normal text-gray-600">
                                                            <ul className="flex flex-col gap-4 list-outside">
                                                                      {item.TimelineBody.Typography.map((text, i) => (
                                                                                <li key={i}>{text}</li>
                                                                      ))}
                                                            </ul>
                                                  </Typography>
          ...
          return <Timeline className="md:w-[50rem] text-[#3f3e3e]">{timelineItems}</Timeline>;
}
