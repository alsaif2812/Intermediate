    ...
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800">Mobile App</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">NeuPOS</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800">Healthcare</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">Manufacturing</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">Distribution</a>
          </li>
          <li>
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800">Real Estate</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">Agriculture</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
