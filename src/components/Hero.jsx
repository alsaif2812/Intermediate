      ...
      <div id="page-1" className="h-full bg-opacity-80 mb-52">
        ...
        <div id="content" className=' mt-5'>
          <div className="w-full max-h-screen flex flex-col md:flex-row mt-[-5vw] md:mt-[-2vw]">
            <div id="left" className="md:w-1/2 md:h-full md:px-12 md:pt-32 md:ml-10  ">
              ...
              <p className='my-5 text-gray-600 font-semibold'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat, suscipit ex. Voluptas <br /> consectetur incidunt, temporibus veniam fugit corporis deleniti ea.</p>
