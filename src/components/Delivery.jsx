                                        ...
                                        <div id="lower" className='my-10 flex flex-col items-center'>
                                                  <div className='flex flex-wrap gap-6 justify-center items-start p-5'>
                                                            {tabs.map((tab, index) => (
                                                                      <div
                                                                                key={index}
                                                                                className={`cursor-pointer ${activeTab === index + 1 ? 'text-black font-extrabold p-8 border-[1px] border-gray-300 rounded-lg scale-110 shadow-lg shadow-red-50 transition duration-300' : 'font-extrabold text-black  border-[1px]  shadow-sm p-8 rounded-lg transition duration-300  hover:scale-95 '}`}
                                                  ...
                                                  <div id="card" className='border-2 border-gray-500 rounded-lg w-full md:w-[70%] lg:w-[60%] xl:w-[70%] py-8 px-10 grid grid-cols-1 md:grid-cols-2 gap-5 shadow-lg shadow-red-100 mt-1'>
                                                            <div id="lft">
                                                                      ...
                                                                      <ul className='text-md font-semibold'>
                                                                                <li><i className="ri-checkbox-circle-line text-sm font-bold mx-2"></i>Lorem ipsum dolor sit amet consectetur.</li>
                                                                                <li><i className="ri-checkbox-circle-line text-sm font-bold mx-2"></i>Lorem ipsum dolor sit amet consectetur.</li>
                                                                                <li><i className="ri-checkbox-circle-line text-sm font-bold mx-2"></i>Lorem ipsum dolor sit amet consectetur.</li>
                                                                      </ul>
                                                            </div>
                                                            <div id="rght" className=' rounded-md '>
                                                                      <ul className='text-sm font-semibold border-2 border-gray-300 rounded-lg'>
                                                                                <li className='border-b-2 border-gray-300 p-3 '><i className="ri-settings-3-line text-lg mx-2"></i>Lorem ipsum dolor sit amet.</li>
                                                                                <li className='border-b-2 border-gray-300 p-3 '><i className="ri-git-repository-fill text-lg mx-2"></i>Lorem ipsum dolor sit amet.</li>
                                                                                <li className='border-b-2 border-gray-300 p-3 '><i className="ri-gallery-fill text-lg mx-2"></i>Lorem ipsum dolor sit amet.</li>
                                                                                <li className=' border-gray-300 p-3 '><i className="ri-thermometer-fill text-lg mx-2"></i> Lorem ipsum dolor sit amet.</li>
                                                                      </ul>
                                                                      <div className='p-4'>
                                                                                <button className="mt-4 bg-gradient-to-r from-[#4695F0] to-[#FC42CE] px-6 py-3 md:py-1 md:px-10 md:text-md rounded-md font-bold text-white shadow-md hover:shadow-lg focus:outline-none focus:ring focus:border-blue-300">
                                                                                          Use this Solution <i className="ri-arrow-right-line"></i>
                                                                                </button>
                                                                      </div>
                                                            </div>
                                                  </div>
