        ...
        <>
            <div className="w-full  md:flex md:h-[30rem] h-[45rem] my-5 md:my-0 items-center justify-center bg-gradient-to-r from-[#CAF2EF] via-[#C9EFDC] to-[#F2BBF1]">
                ...
                <div className="md:w-[30%] w-full  md:py-4 md:px-0 px-6">
                    <div id="text">
                        <p className="uppercase text-sm font-extrabold text-purple-600 ">
                            software
                        </p>
                        <h1 className="md:text-4xl text-3xl font-bold text-[#2e2e2e] my-2">
                            10 best mindgrasp AI Alternative in 2023 (Reviews &
                            Pricing)
                        </h1>
                        <div
                            id="name"
